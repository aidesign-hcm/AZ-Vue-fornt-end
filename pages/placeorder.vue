          ...
          <div class="spc-orders a-box">
            <div class="a-box-inner">
              <div class="shipping-group">
                ...
                >Estimated delivery: {{shippingEstimated}}</div>
                <div class="row">
                  <!-- Cart -->
                    ...
                    <div class="a-row shipping-speeds">
                        ...
                        <div class="a-spacing-mini wednesday">
                          ...
                          <v-radio-group v-model="radios">
                            <v-radio @change="onChoosenShipping('normal')" value="normal" label="Normal: Averages 7 business days"><strong>Normal: Averages 7 business days</strong></v-radio>
                            <v-radio @change="onChoosenShipping('fast')" value="fast" label="Fast: Averages 3 business days">Fast: <strong>Averages 3 business days</strong></v-radio>
                          </v-radio-group>
                        </div>
                    </div>
                  </div>
                ...
                <div class="a-row">
                  ...
                  <div class="order-summary" style="font-size: 12px;">
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">USD ${{getCartTotal}}</div>
                    </div>
                    <div class="row">
                      <!-- Shipping cost -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">USD {{getCartTotalWithShiping}}</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">
                        <!-- Total Price with Shipping -->
                        <div class="a-color-price a-size-medium a-text-bold">USD {{getCartTotalWithShiping}}</div>
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  async asyncData({store, $axios}) {
    try {
      ...
      store.commit('setShipping',{
        ...
        estimated: response.shipment.estimated
      } )
  ...
  computed: {
      ...mapGetters(["getCartTotal", "getCart", "getCartTotalWithShiping"])
  },
  methods: {
